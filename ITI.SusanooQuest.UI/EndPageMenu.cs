        ...
        public EndPageMenu(RenderWindow window, bool win)
        {
            ...
            if (win)
            {
                ...
                _creditTexts = new Text[19]
                {
                    ...
                    new Text("Graphismes par :", _font) { CharacterSize = 80, FillColor = Color.White, Position = new Vector2f(150, 2280) },
                    ...
                    new Text("Sons par :", _font) { CharacterSize = 80, FillColor = Color.White, Position = new Vector2f(150, 2540) },
